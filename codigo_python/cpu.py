...
class CPU:
    def __init__(self):
        self.cpu_load_percent # porcentaje de uso de la cpu
        self.cpu_freq_mhz # frecuencia de la cpu
        self.cpu_user_percent # porcentaje de tiempo que la cpu está con programas de usuario
        self.cpu_kernel_percent # porcentaje de tiempo que está la cpu con el kernel
        self.cpu_iowait_percent  # porcentaje de tiempo inactivo esperando disco duro
        self.cpu_steal_percent # porcentaje de tiempo perdido esperando a que el servidor fisico nos asigne recursos
        self.cpu_inactive_percent # porcentaje de tiempo que la cpu estuvo libre, sin hacer nada
        self.cpu_interrupts  # Cantidad de interrupciones, ya sean de teclado, de ratón etc
        self.ctx_switches # cantidad de cambios de contexto 
        self.load_avg_1m
        self.load_avg_5m
        self.load_avg_15m
