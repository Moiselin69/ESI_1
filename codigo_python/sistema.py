...
class Sistema:
    def __init__(self):
        self.total_processes = 0 # total de procesos en activo
        self.total_threads = 0 # total de hilos en activo
        self.active_users = 0 # usuarios que están activos
        self.uptime_seconds = 0 # tiempo que lleva encendido el sistema
